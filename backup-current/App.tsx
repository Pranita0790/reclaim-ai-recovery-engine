...
function App() {
  ...
  const [customerAttempts, setCustomerAttempts] =
    useState("0");

  const [daysSinceFailure, setDaysSinceFailure] =
    useState("1");
    ...
    try {
      ...
      const payload = {
        ...
        customer_attempt_count:
          Number(customerAttempts),
        days_since_failure:
          Number(daysSinceFailure),
        is_customer_active:
          isCustomerActive,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Submit a recovery case and
              watch RECLAIM evaluate risk,
              compare actions, apply policy,
              and execute the highest-value
              decision.
            </p>
          </div>
